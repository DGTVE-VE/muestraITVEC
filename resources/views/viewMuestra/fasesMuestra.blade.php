...
<section id="cd-timeline" class="cd-container">
    ...
    <div class="cd-timeline-block">
        ...
        <div class="cd-timeline-content text-justify">
            ...
            <hr>
            <br>
            <p>Se abrirá un espacio en este sitio y en las redes sociales del evento con las producciones que hayan concluido su registro, por lo que el público podrá votar por su favorita.</p>                    
            <br>
            <p>Las producciones con más votos se presentarán durante el Primer Encuentro Internacional de Innovación y Tecnología para la Educación (INNTEDU), en la Ciudad de México.</p>
    ...
    <div class="cd-timeline-block">
        ...
        <div class="cd-timeline-content">
            ...
            <hr>
            <br><br><br><br>
            <p>El resultado de las producciones finalistas será publicado en esta página</p>
    ...
    <div class="cd-timeline-block">
        ...
        <div class="cd-timeline-content text-justify">
            ...
            <hr>
            <p>Las producciones finalistas tendrán que enviar una versión resumida de su proyecto participante, la cual deberá tener una duración de máximo 15 minutos. La fecha de envío será a más tardar el 03 de octubre (hasta las 23:59 horas del centro de México). Las especificaciones serán enviadas a los correos electrónicos registrados.
            </p>
            <br>
            <p>En caso de no cumplir con alguna de las especificaciones mencionadas, el proyecto será descalificado.</p>          
    ...
    <div class="cd-timeline-block">
        ...
        <div class="cd-timeline-content text-justify">
            <h2 class="text-center">Presentación de producciones</h2>
            <hr>
            <p>La presentación de las producciones finalistas se realizará el día 12 de octubre de 12:00 a 17:00 horas, en el Auditorio Blas Galindo, del Centro Nacional de las Artes, Ciudad de México.</p>                    
            <ul><br>
                <li>El evento contará con un jurado especialista, quien evaluará los materiales presentados y decidirá e informará quiénes serán las producciones ganadoras.</li>
                <br><br>
                <li>Los criterios de evaluación a considerar son: creatividad, entretenimiento, interactividad y alineación la categoría en la que se encuentre inscrita la producción. </li>
                <br><br>
            </ul>
    ...
    <div class="cd-timeline-block">
        ...
        <div class="cd-timeline-content">
            <h2 class="text-center">Premiación</h2>
            <hr>
            <br><br><br>
            <p>La ceremonia de premiación se llevará a cabo el día 13 de octubre a las 11:00 horas., en el Auditorio Blas Galindo, del Centro Nacional de las Artes, Ciudad de México, a cargo de las autoridades correspondientes.</p>
            <br><br><br><br><br>
